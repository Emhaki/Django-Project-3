    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delivery_option', models.CharField(choices=[('부재시 문 앞에 놓아주세요.', '부재시 문 앞에 놓아주세요.'), ('부재시 경비실에 맡겨주세요.', '부재시 경비실에 맡겨주세요.'), ('부재시 전화 또는 문자주세요.', '부재시 전화 또는 문자 주세요.'), ('택배함에 넣어주세요.', '택배함에 넣어주세요.'), ('파손위험이 있는 상품입니다. 배송 시 주의해주세요.', '파손위험이 있는 상품입니다. 배송 시 주의해주세요.'), ('배송 전에 연락주세요.', '배송 전에 연락주세요.')], default='부재시 문 앞에 놓아주세요.', max_length=50)),
